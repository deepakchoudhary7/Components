...
extension UIView {
    ...
    func addNoLabel() -> UILabel {
        let messageLabel = UILabel(frame: CGRect(x: 10, y: 0, width: self.bounds.size.width - 20, height: self.bounds.size.height))
        messageLabel.text = ""
        messageLabel.text = NO_DATA_FOUND
        messageLabel.numberOfLines = 0;
        messageLabel.textAlignment = .center
        messageLabel.font = UIFont(name: PLAY_REGULAR, size: 20.0)!
